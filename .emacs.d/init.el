...
(custom-set-faces
 ...
 ;; '(org-level-1 ((t (:inherit outline-1 :height 1.728  :foreground "#FD971F"))))
 ;; '(org-level-2 ((t (:inherit outline-2 :height 1.44  :foreground "#A6E22E"))))
 ;; '(org-level-3 ((t (:inherit outline-3 :height 1.2  :foreground "#66D9EF"))))
 ;; '(org-level-4 ((t (:inherit outline-4 :height 1.1  :foreground "#E6DB74"))))
